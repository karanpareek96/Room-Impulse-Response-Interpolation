...
%
% Note: Imports all angles and computes interpolation
% 
% INPUT: Room name (name)
% OUTPUT: Type 1 matrix (angles_A), Type 2 matrix (angles_B), 
%         Type 3 matrix (angles_C), Type 4 matrix (angles_D)

function [angles_A,angles_B,angles_C,angles_D,dimensions] = compute_room_selector_1(roomType)

%% Room Types with angles

if strcmp(roomType,'Room 01')
    angles = [0, 25, 30, 45, 60, 90, 110, 120, 135, 150, 180, 210, 225, 240, 250, 270, 300, 315, 330, 335];
    L = 5;
    W = 5.5;
    H = 3;
...
elseif strcmp(roomType,'Room 07A')
    angles = [0, 30, 45, 60, 90, 105, 120, 135, 150, 180, 210, 225, 240, 255, 270, 300, 315, 330];
    L = 10.31;
    W = 5.76;
    H = 3.10;
